  ...
  const { site, siteLogo, defaultFb } = useStaticQuery(
    graphql`
      query {
        ...
        siteLogo: file(relativePath: { eq: "enerphase-logo.png" }) {
          publicURL
        }

        defaultFb: file(relativePath: { eq: "enerphase-logo.png" }) {
          publicURL
        }
      }
    `
    ...
    <React.Fragment>
      <Helmet htmlAttributes={{ lang }}>
        ...
        <meta
          ...
          content="fwmyklXjFLaB7mxmDGsOlMp8MjkU7mPmeO35Th2bdWo"
        />
      ...
      <SchemaOrg
        ...
        defaultTitle="Ener-Phase Solutions"
      />
    </React.Fragment>
  )
}
